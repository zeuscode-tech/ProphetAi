          ...
          <div className="mx-4 mt-4">
            <div className="glass mx-auto flex max-w-6xl items-center justify-between rounded-2xl px-6 py-3">
              ...
              <div className="flex items-center gap-1 text-sm">
                <a href="/dashboard" className="rounded-xl px-4 py-2 text-slate-400 transition-colors hover:text-white cursor-pointer">Дашборд</a>
                <a href="/" className="rounded-xl bg-gradient-to-r from-neon-cyan to-neon-blue px-5 py-2 font-semibold text-surface transition-all hover:shadow-glow cursor-pointer">Новый анализ</a>
              </div>
            </div>
          </div>
        </nav>
